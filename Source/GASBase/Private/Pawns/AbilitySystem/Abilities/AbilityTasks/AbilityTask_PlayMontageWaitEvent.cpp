...
UGASAbilitySystemComponent* UAbilityTask_PlayMontageWaitEvent::GetTargetASC()
{
...
void UAbilityTask_PlayMontageWaitEvent::Activate()
{
	...
	UGASAbilitySystemComponent* GDAbilitySystemComponent = GetTargetASC();
	...
	if (GDAbilitySystemComponent)
	{
		...
		if (AnimInstance != nullptr)
		{
			...
			EventHandle = GDAbilitySystemComponent->AddGameplayEventTagContainerDelegate(EventTags, FGameplayEventTagMulticastDelegate::FDelegate::CreateUObject(this, &UAbilityTask_PlayMontageWaitEvent::OnGameplayEvent));
