...
#include "AbilityTask_MoveSceneComponent.generated.h"
...
*/
UCLASS()
class GASBASE_API UAbilityTask_MoveSceneComponent : public UAbilityTask
{
	...
	static UAbilityTask_MoveSceneComponent* MoveSceneComponentRelativeLocation(UGameplayAbility* OwningAbility, FName TaskInstanceName, USceneComponent* SceneComponent, FVector Location, float Duration, UCurveFloat* OptionalInterpolationCurve, UCurveVector* OptionalVectorInterpolationCurve);
