...
#include "AbilityTask_WaitInputWithTags.generated.h"
...
*/
UCLASS()
class GASBASE_API UAbilityTask_WaitInputWithTags : public UAbilityTask
{
	...
	*/
	...
	static UAbilityTask_WaitInputWithTags* WaitInputPressWithTags(UGameplayAbility* OwningAbility, FGameplayTagContainer RequiredTags, FGameplayTagContainer IgnoredTags, bool bTestAlreadyPressed = false);
