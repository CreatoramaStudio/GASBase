...
*/
UCLASS()
class GASBASE_API UAsyncTaskGameplayTagAddedRemoved : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
	...
	virtual void TagChanged(const FGameplayTag Tag, const int32 NewCount);
};
