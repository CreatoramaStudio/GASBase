...
*/
UCLASS()
class GASBASE_API UAsyncTaskCooldownChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
	...
	// UseServerCooldown determines if the Server's cooldown is returned in addition to the local predicted cooldown.
